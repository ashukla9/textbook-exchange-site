...
class MyApp extends StatelessWidget { //immutable widget, stateless
  @override
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(primaryColor: Colors.purple[50]), //change theme color and appbar color

      initialRoute: "/",
      routes: routes, //routes is the Map we have in routes.dart [source: https://morioh.com/p/99b14cbf048e]
